...
#include "../../Test_OAuth_Console/OAuth.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OAuth_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 39, 3)
    ...
    "OAuth\0ReceptionReponse\0\0QNetworkReply*\0"
    "rep"
};
...
void OAuth::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->ReceptionReponse((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        default: ;
        }
